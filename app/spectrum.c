...
void DrawLabels(void) {
	...
	UI_DrawSmallString(61, 86, (bHold) ? "<HOLD>" : ">SRCH<", 6);// Hold/Srch

	gColorForeground = COLOR_GREY;// GREY or FOREGROUND or COLOR_RGB(31, 63, 31)
...
void IncrementModulation(void) {
	...
	DrawCurrentFreq((bRXMode) ? COLOR_FOREGROUND : COLOR_FOREGROUND);
}
...
void Spectrum_Loop(void) {
	...
	DISPLAY_DrawRectangle0(0, 11, 160, 1, gColorForeground);
