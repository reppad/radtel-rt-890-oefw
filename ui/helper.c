...
void UI_DrawRoger(void)
{
	...
	case 0:
		...
		UI_DrawSmallString(32, 86, "  ", 2);
		break;
	case 1:
		UI_DrawStatusIcon(20, ICON_BELL, true, COLOR_RED);
		UI_DrawSmallString(32, 86, "R1", 2);
		break;
	case 2:
		UI_DrawStatusIcon(20, ICON_BELL, true, COLOR_BLUE);
		UI_DrawSmallString(32, 86, "R2", 2);
		break;
	case 3:
		UI_DrawStatusIcon(20, ICON_BELL, true, COLOR_GREEN);
...
{
	Y = 43 - (Y * 41);
	DISPLAY_DrawRectangle0( 20, Y, 100, 1, COLOR_GREY);
	DISPLAY_DrawRectangle1( 20, Y,   6, 1, COLOR_GREY);
	DISPLAY_DrawRectangle1(120, Y,   6, 1, COLOR_GREY);
	DISPLAY_DrawRectangle1( 45, Y,   5, 1, COLOR_GREY);
	DISPLAY_DrawRectangle1( 70, Y,   5, 1, COLOR_GREY);
	DISPLAY_DrawRectangle1( 95, Y,   5, 1, COLOR_GREY);
}
