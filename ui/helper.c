...
void UI_DrawTxPower(bool bIsLow, uint8_t Vfo)
{
	...
	if (bIsLow) {
		gColorForeground = COLOR_FOREGROUND;
		UI_DrawSmallString(132, Y, "LOW ", 4);
	} else {
		gColorForeground = COLOR_FOREGROUND;
		UI_DrawSmallString(132, Y, "HIGH", 4);
	}
}
...
//{
	...
	//DISPLAY_DrawRectangle0(0, 81, 160, 1, gColorForeground);
...
void UI_DrawDecimal(const char *pInput)
{
	...
	String[4] = String[3];
	String[3] = '.';
	UI_DrawSmallString(103, 86, String, 5);
}
